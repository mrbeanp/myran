...
async def advantage_spell_chok(msg):
    ...
    m = await msg.reply("നിങ്ങൾ സേർച്ച് ആക്കിയ മൂവി താഴെ കാണുന്ന ലിസ്റ്റില് ഉണ്ടെങ്കിൽ നിങ്ങൾക്ക് വേണ്ട സൈസ് നോക്കി ബട്ടൺ പ്രസ് ചെയ്യുക.ഇനി മൂവി ഇല്ലങ്കിൽ താഴെ ഉള്ള സേർച് ഗൂഗിൾ പോയിട്ട് മൂവിയുടെ വർഷം നോക്കി ഇവിടെ ഒന്നൂടെ  മൂവിയുടെ പേരും വർഷവും ടൈപ്പ് ചെയ്യുക I couldn't find anything related to that\nDid you mean any one of these?",
                    reply_markup=InlineKeyboardMarkup(btn))
