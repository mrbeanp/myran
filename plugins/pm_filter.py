...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('𝚃𝙷𝙸𝚂 𝙼𝙾𝚅𝙸𝙴 I𝚂 𝙽𝙾𝚃 𝚈𝙴𝚃 𝚁𝙴𝙻𝙴𝙰𝚂𝙴𝙳 𝙾𝚁 𝙰𝙳𝙳𝙴𝙳 𝚃𝙾 𝙳𝙰𝚃𝚂𝙱𝙰𝚂𝙴 ⭕ <b>[𝚂𝙴𝙰𝚁𝙲𝙷 𝙶𝙾𝙾𝙶𝙻𝙴](https://www.google.com/search?q=)⭕ ')
...
async def advantage_spell_chok(msg):
    ...
    btn.append([InlineKeyboardButton(text="𝚂𝙴𝙰𝚁𝙲𝙷 𝙶𝙾𝙾𝙶𝙻𝙴", url="https://www.google.com/find?q={reply")])
